...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(df[df['education']=="Bachelor's"].shape[0]/df.shape[0]*100,1)
    ...
    top_IN_occupation = df[df[(native_country=='India')] & q2]/['occupation'].value_counts().index[0]
